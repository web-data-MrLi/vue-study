      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <v-contain :max="100" :min="20"></v-contain>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-selection :versionLists="tradeList"></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-choosemuch :choosemuch="versionList"></v-choosemuch>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
